...
public class ViewMedicine extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 14, -1, -1));
        ...
        getContentPane().add(jSeparator1, new org.netbeans.lib.awtextra.AbsoluteConstraints(16, 84, 818, 10));
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(41, 110, 758, 295));

        jLabel2.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
        jLabel2.setText("Click on Row to Delete Medicine");
        getContentPane().add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(319, 423, 200, -1));
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        if (a == 0) {
            try {
                ...
                // If `medicine_pk` is an integer in the database
                ps.setInt(1, Integer.parseInt(id));

                ps.executeUpdate();
                JOptionPane.showMessageDialog(null, "Medicine Successfully Deleted");

                // Refresh the table here instead of reinitializing the whole view
